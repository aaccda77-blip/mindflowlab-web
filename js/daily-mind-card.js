...
(function () {
  ...
  function resolveBookUrl(card, config) {
    ...
    if (bookTitle.includes('다크')) {
      return cfg.DARK_CODE_URL || cfg.DARK_CODE_BOOK_URL || 'https://www.yes24.com/product/goods/196721492';
      ...
      return cfg.ZERO_POINT_URL || cfg.ZERO_POINT_BOOK_URL || cfg.PUBLISHER_URL || 'https://www.yes24.com/product/goods/195946431';
